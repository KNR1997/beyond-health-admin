...
import { DentalProblem, MedicalVital, SortOrder } from '@/types';
...
type IProps = {
  medicalVitals: MedicalVital[] | undefined;
  paginatorInfo: MappedPaginatorInfo | null;
  onPagination: (current: number) => void;
  onSort: (current: any) => void;
  onOrder: (current: string) => void;
};
const MedicalVitalList = ({
  medicalVitals,
  paginatorInfo,
  onPagination,
  onSort,
  ...
  const columns = [
    ...
    },
    {
      ...
      align: 'right',
      width: 260,
      render: (id: string, record: MedicalVital) => (
        <LanguageSwitcher
          slug={id}
          record={record}
          // deleteModalView="DELETE_COUPON"
          // deleteBySlug={record.id}
          routes={Routes?.medicalVital}
...
export default MedicalVitalList;
