...
export default function TreatmentPlanEditPageHeader({
  pageTitle,
  treatmentPlanId,
}: {
  pageTitle: string;
  ...
  const childMenu = [
    {
      href: Routes.treatmentPlan.editWithoutLang(treatmentPlanId),
      label: 'text-general-info',
      icon: 'SettingsIcon',
    },
    {
      href: Routes.treatmentPlan.items(treatmentPlanId),
      label: 'text-items',
      icon: 'RefundsIcon',
    },
  ];
