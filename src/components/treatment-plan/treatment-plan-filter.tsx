...
import { AppointmentStatus, Dentist, TreatmentPlanStatus } from '@/types';
// components
...
export default function TreatmentPlanFilter({
  onPatientFilter,
  onDentistFilter,
  onStatusFilter,
  onDateRangeFilter,
  ...
  const statusOptions = [
    {
      label: 'Proposed',
      value: TreatmentPlanStatus.PROPOSED,
    },
    {
      label: 'Accepted',
      value: TreatmentPlanStatus.ACCEPTED,
    },
    {
      label: 'In Progress',
      value: TreatmentPlanStatus.IN_PROGRESS,
    },
    {
      label: 'Completed',
