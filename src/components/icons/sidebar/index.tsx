...
export { ToothIcon } from '@/components/icons/sidebar/tooth';
export { DentalDrillIcon } from '@/components/icons/sidebar/dental-drill';
export { PatientIcon } from '@/components/icons/sidebar/patient';
export { WheelChairDisabledIcon } from '@/components/icons/sidebar/wheel-chair-disabled';
